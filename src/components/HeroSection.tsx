...
const HeroSection = () => {
  return (
    <div style={{ backgroundImage: `url(${banner})` }} className={`h-[88vh] bg-cover bg-center`}>
      <Particle />
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          <h1 className="text-[35px] md:text-[50px] text-white font-bold">
            Hi, I'm <span className="text-yellow-400">Thành</span>
          </h1>
          <TextEffect />
          <p className="mt-[1.5rem] text-[18px] text-gray-200">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed assumenda quos beatae,
            iure a eveniet ipsam, dicta natus tenetur quidem amet at dolor architecto rerum sit
            similique delectus laborum nesciunt.
          </p>
